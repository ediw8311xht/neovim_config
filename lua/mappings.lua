...
LEADER_MAPPINGS = {
  n = {
    ...
    W     = { F, 'write',                   ':w<ESC>'},
    b     = { F, 'open buffer',             function() require("telescope.builtin").buffers({ignore_current_buffer=true, disable_coordinates = true, sort_lastused=true}) end },
    c     = { group="editor setting"},
    cA    = { F, 'autofold comments OFF',   'AutoFoldComments off',cmd=true},
    ...
    ca    = { F, 'autofold comments ON',           'AutoFoldComments multi',cmd=true},
